...
func IDIn(ids ...int) predicate.GroceryItem {
	return predicate.GroceryItem(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.GroceryItem {
	return predicate.GroceryItem(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func CreatedAtIn(vs ...time.Time) predicate.GroceryItem {
...
func CreatedAtNotIn(vs ...time.Time) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedAtIn(vs ...time.Time) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ModifiedAtNotIn(vs ...time.Time) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedAtIn(vs ...time.Time) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func DeletedAtNotIn(vs ...time.Time) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NameIn(vs ...string) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func NameNotIn(vs ...string) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusIn(vs ...Status) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func StatusNotIn(vs ...Status) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceIn(vs ...float64) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func PriceNotIn(vs ...float64) predicate.GroceryItem {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func HasGrocerylist() predicate.GroceryItem {
	return predicate.GroceryItem(func(s *sql.Selector) {
...
func HasGrocerylistWith(preds ...predicate.GroceryList) predicate.GroceryItem {
	return predicate.GroceryItem(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
